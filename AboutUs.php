    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h4 class="display-4 m-3">About Us</h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 my-2">
                <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores nihil a dolore iste
                    explicabo voluptatibus enim consequuntur blanditiis quisquam vero. Fugiat et facilis aut
                    necessitatibus fugit sed odit iste repudiandae possimus minima deserunt dolores totam sapiente
                    beatae fuga, adipisci reprehenderit, praesentium nesciunt, numquam esse culpa enim. Unde quia
                    veritatis reiciendis dolorum ullam exercitationem! Deleniti exercitationem ipsa temporibus nemo
                    tempora. Sequi ab veritatis eius ipsum commodi vel sunt omnis ex quidem asperiores unde at vitae
                    molestias eos ducimus sapiente, ad corrupti, non, excepturi deleniti facere. Perferendis, ab?
                    Asperiores doloribus dolor aut optio a incidunt natus nesciunt atque deleniti. Assumenda, optio
                    corporis.</p>
            </div>
            <div class="col-md-6 my-2">
                <img src="Background-Images/Background-image-1.jpg" alt="" class="img-fluid shadow aboutImg">
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid bg-dark">
        <div class="row pt-2">
            <div class="col-lg-4 col-md-4 p-2">
                ...
                <div class="p-1 ml-4">
                    <a href="AboutUs.php" class="text-white"><b>About Us</b></a>
                </div>
                <div class="p-1 ml-4">
