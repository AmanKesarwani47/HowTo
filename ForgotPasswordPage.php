...
<?php
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <div class="container">
      <a href="AdminLoginPage.php" class="navbar-brand text-white bg-danger d-inline px-3 curved-end">HowTo <i
            ...
            <div class="col-lg-4 col-md-6 col-sm-8 col-xs-12">
                <div style="background-image: url(Login-Background-Images/Background-image-2.jpg); background-size: cover; box-shadow: 0px 0px 10px 2px; border-radius: 25px; margin-top: 15vh;">
                    ...
                    <div class="form-group">
                            <label for="Email"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;Email</label>
                            ...
                            <?php
                                if(isset($_GET['email'])){
                                    ...
                                    elseif($_GET['email'] === 'notfound'){
                                        echo "<p class = 'text-danger '> Email Not Found. Please <a href='Signup.php'>Signup</a></p>";
                                    }
                                }
                            ...
                            <?php
                                if(isset($_GET['password'])){
                                    ...
                                    elseif($_GET['password'] === 'incorrect'){
                                        echo "<p class = 'text-danger '>Password are not same</p>";
                                    }
                                    elseif($_GET['password'] === 'pd_char8'){
                                        echo "<p class = 'text-danger '>Password length should be between 1-8</p>";
                                    }
                                }
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                if(isset($_GET['cpassword'])){
                                    ...
                                    elseif($_GET['cpassword'] === 'incorrect'){
                                        echo "<p class = 'text-danger '>Password are not same</p>";
                                    }
                        ...
                        <h6 class="text-center"><a href="LoginPage.php">LOGIN</a> </h6>
                        <div class="form-group text-center">
                            <button class="btn btn-danger curved-end px-5 py-2" type="submit" name="Change">Change Password</button>
                        </div>
                    </form>
                </div>
            </div>
