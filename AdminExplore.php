                    ...
                    <li class="nav-item dropdown m-1">
                        ...
                        <div class="dropdown-menu bg-dark">
                            <a href="AdminWrite_an_Article.php" class="dropdown-item bg-dark text-white">Write an
                                Article</a>
                            <!-- <a href="AdminAboutUs.php" class="dropdown-item bg-dark text-white">About Us</a> -->
                        </div>
                    </li>
                                ...
                                if($show_comment){
                                    if(mysqli_num_rows($show_comment) > 0){
                                        while($commentrow = mysqli_fetch_assoc($show_comment)){
                                            ...
                                            echo '<div class="card-title p-2">'.$username.'<small class="text-muted"> '.$date.'</small></div>
    ...
    <div class="container-fluid bg-dark">
        <div class="row pt-2">
            <div class="col-lg-4 col-md-4 p-2">
                ...
                <div class="p-1 ml-4">
                    <a href="AdminExplore.php" class="text-white"><b>Explore</b></a>
                </div>
                <!-- <div class="p-1 ml-4">
