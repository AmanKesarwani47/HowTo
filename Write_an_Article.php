...
<body>
    ...
    <?php
        ...
        include "Write_an_Article_Database.php";
    ?>
        ...
        <div class="row m-2">
            ...
            <div class="col-md-4">
                <div class="text-center">
                    <a href="Explore.php" class="btn btn-outline-primary m-2 ">Random Article</a>
                    <a href="Write_an_Article.php" class="btn btn-outline-primary m-2 ">Write An Article</a>
                </div>
            </div>
        </div>
        <div class="row ">
            ...
            <div class="col-md-6 m-5">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group p-2 text-center">
                        <button class="btn btn-danger btn-lg" name="articlePost"><i class="fa fa-paper-plane" aria-hidden="true"></i>&nbsp;Post</button>
    ...
    <div class="container-fluid bg-dark">
        <div class="row pt-2">
            <div class="col-lg-4 col-md-4 p-2">
                ...
                <div class="p-1 ml-4">
                    <a href="Write_an_Article.php" class="text-white"><b>Write an Article</b></a>
                </div>
            </div>
